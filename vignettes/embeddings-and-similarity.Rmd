...
#> # A tibble: 3 x 5
#>   doc_id category text                                      similarity  rank
#>    <int> <chr>    <chr>                                          <dbl> <int>
#> 1      1 tech     Neural networks power modern AI systems        0.78     1
#> 2      2 tech     Cloud computing enables scalable applic...     0.52     2
#> 3      5 travel   Tokyo offers incredible street food ...        0.18     3
```
