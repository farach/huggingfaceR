...
any feature-extraction model that is available on the Hugging Face Inference API.
Not every model on the Hub is served by the Inference API — use
`hf_check_inference(model_id)` to verify before switching models.
