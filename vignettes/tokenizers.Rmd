...
You may have noticed that `hf_load_tokenizer` accepts `...`.  This allows you to provide an arbitrary number of arguments. Common arguments are 'return_tensors = pt', or 'use_fast = TRUE/FALSE'.
