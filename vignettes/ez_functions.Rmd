...
knitr::kable(zero_shot_classifications %>% head(10), row.names = NA, caption = 'Zero Shot Classification Results', digits = 2)
```
...
knitr::kable(misclassified_texts, row.names = NA, caption = 'Zero Shot Classification Results', digits = 2)
```
