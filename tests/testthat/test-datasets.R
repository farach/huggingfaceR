...
int_to_str <- hf_load_dataset("emotion", label_conversion = "int2str")
test_that("int2str is working", {
  expect_true(int_to_str[[1]][1, 3]$label_name == "sadness")
})
